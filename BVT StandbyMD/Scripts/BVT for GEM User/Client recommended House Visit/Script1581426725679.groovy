...
WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Terms of Use_Address'), 'kigali caree')
...
WebUI.selectOptionByValue(findTestObject('Page_StandbyMD Directional Care/select_HouseHotel'), '1', true)

WebUI.click(findTestObject('Page_StandbyMD Directional Care/button_Confirm'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/span_Chappedeline Pharmacy Ltd'))

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_RoomNumber_Email'), 'laetitia.i@muraho.tech')

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/input_Email_Phone'), '0788509927')

WebUI.setText(findTestObject('Page_StandbyMD Directional Care/textarea_Phone_Comments'), 'sick')

WebUI.click(findTestObject('Page_StandbyMD Directional Care/button_Next_1_2_3_4_5'))
