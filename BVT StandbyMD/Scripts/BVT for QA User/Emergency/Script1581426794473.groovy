...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/i_Kigali Convention Centre KG 2 Roundabout _7b4ae4'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/button_Yes'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/span_HOSPITAL -UBUZIMA POLYCLINIC'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/div_Distance'))
