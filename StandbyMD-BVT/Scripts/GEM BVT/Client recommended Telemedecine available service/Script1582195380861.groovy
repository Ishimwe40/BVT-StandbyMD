...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/div_No'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/input_DOB_DOB'))

WebUI.sendKeys(findTestObject('Page_StandbyMD Directional Care/input_DOB_DOB'), '01181958')

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/img_Male_img-responsive'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/label_Symptom Selector'))
...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/button_Next_1_2'))
...
WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/button_Next_1_2_3'))
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_StandbyMD Directional Care/select_Online VideoChat Consultation'), 
    '2', true)

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/span_PJC Jean Coutu Health-Beauty'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/button_Next_1_2_3_4'))

WebUI.setText(findTestObject('Object Repository/Page_StandbyMD Directional Care/input_Claim_LinkClaimNumber'), '123456')

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/input_Claim_bttn-pill bttn-md bttn-primary'))

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/button_Link Claim'))

WebUI.click(findTestObject('Page_StandbyMD Directional Care/span_Submit Request'))

WebUI.setText(findTestObject('Object Repository/Page_StandbyMD Directional Care/input_E-Mail_Email'), 'laetitia.i@muraho.tech')

WebUI.click(findTestObject('Object Repository/Page_StandbyMD Directional Care/input_Mobile_btnSendClientSum'))
